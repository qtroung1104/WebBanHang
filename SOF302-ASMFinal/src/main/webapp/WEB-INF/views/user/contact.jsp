                    ...
                    <div class="contacts">
                        <section class="contacts__item">
                            ...
                            <div class="contacts__right">
                                <a class="contacts__number">(024) 6327 6402 – 0981 725 836</a><br>
                                <a class="contacts__link">caodangfpt@fpt.edu.vn</a>
                            </div>
                        </section>
                        <section class="contacts__item">
                            <div class="contacts__left">
                            ...
                            <div class="contacts__right">
                                <span class="contacts__text">Lot 137, Nguyễn Thị Thập,<br> District Liên Chiểu, Đà Nẵng</span>
                            </div>
                        </section>
                        <section class="contacts__item">
                            <div class="contacts__left">
